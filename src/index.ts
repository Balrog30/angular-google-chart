...
/// <reference path="googlechart.module.ts" />
/// <reference path="agcBeforeDraw.ts" />
/// <reference path="agcOnClick.ts" />
/// <reference path="agcOnError.ts" />
...
/// <reference path="googleChartApiPromise.ts" />
